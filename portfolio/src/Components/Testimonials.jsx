    ...
    const testimonials=[
        {
            ...
            name:'Alia',
            role:'patient',
            content:'ertyu dfghj ertyu cvbn',
            rating:5,
            image:'hero.png'
        },
          {
            ...
            <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                <div className='text-center mb-16'>
                    ...
                    <p className='mt-4 text-xl text-gray-600'>
                        Patient testimonials are positive experiences shared by patients who consulted with a 
                        medical professional/ healthcare organization. They can help to show that your practice 
                        is providing quality care & that patients are satisfied with the services they have received. 
                    </p>
                </div>
                <div className='relative'>
                        ...
                        {testimonials.map((testimonial,index)=>(
                            <div key={testimonial.id} className='w-full flex-shrink-0 px-4'>
                                <div className='bg-white p-8 rounded-3xl shadow-xl flex flex-col md:flex-row items-center'>
                                    ...
                                    <div className='relative'>
                                        <img className='w-40 h-40 rounded-full object-cover border-sky-100 shadow-lg'
                                    ...
                                    <div className='md:w-2/3 md:pl-12'>
                                       <div className='relative'>
                                        ...
                                        <p className='text-lg text-gray-700 mb-6 relative xz-10'>{testimonials.content} 
                                       ...
                                       <div className='flex items-center justify-between'>
                                        <div>
                                            ...
                                            <div className='flex mt-1'>
                                                {[...Array(5)].map((_,i)=>(
                                                    <FaStar key={i}
                                                    className={`text-lg ${i<testimonials.rating ?'text-yellow-400':'text-gray-300' }`}/>
                                                ))}
                                            </div>
                                        </div>
                                        <div className='hidden md:flex space-x-2'>
                                            ...
                                            className='p-2 rounded-full bg-sky-100 text-sky-100 hover:bg-sky-200
                                            transition-colors'>
                                                <FaChevronLeft/>
                                            </button>
                                            <button
                    ...
                    <div className='flex justify-center mt-8 space-x-4 md:hidden'>
                        {testimonials.map((_,index)=>(
                            ...
                            className={`w-3 h-3 rounded-full ${currentIndex=== index ? 'bg-sky-600':'bg-gray-300'}`}>
                ...
                <div className='mt-16 text-center'>
                    <button className='px-8 py-3 bg-sky-600 test-white rounded-full font-medium hover:bg-sky-700
...
// style={{transform:`(-${currentIndex = 100}%)`}}